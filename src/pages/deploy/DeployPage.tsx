...
const DeployPage = () => {
  ...
  const embedCode = `<iframe src="${widgetUrl}" width="400" height="600" frameborder="0" style="border-radius:14px;box-shadow:0 4px 24px rgba(0,0,0,0.15)"></iframe>`;
    ...
    <PageWrapper>
      ...
      <div className="max-w-[640px]">
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-[14px] border border-border bg-card p-5" style={{ boxShadow: 'var(--shadow-sm)' }}>
            <h3 className="mb-3 flex items-center gap-2 text-[13px] font-medium text-muted-foreground">
              <Code className="h-3.5 w-3.5 text-primary" /> Iframe Embed
            </h3>
            ...
            <button onClick={() => copy(embedCode)} className="mt-2 inline-flex items-center gap-1 text-[12px] font-medium text-primary hover:underline">
          ...
          <div className="rounded-[14px] border border-border bg-card p-5" style={{ boxShadow: 'var(--shadow-sm)' }}>
            <h3 className="mb-3 flex items-center gap-2 text-[13px] font-medium text-muted-foreground">
              <Code className="h-3.5 w-3.5 text-primary" /> Floating Widget Script
            </h3>
            <pre className="overflow-x-auto rounded-[10px] bg-[hsl(var(--color-surface-3))] p-3 font-mono text-[12px] text-foreground">{scriptCode}</pre>
            <button onClick={() => copy(scriptCode)} className="mt-2 inline-flex items-center gap-1 text-[12px] font-medium text-primary hover:underline">
