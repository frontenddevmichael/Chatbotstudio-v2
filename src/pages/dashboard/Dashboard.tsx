...
import { Bot, MessageSquare, BarChart3, Zap, Plus, AlertTriangle, ChevronRight, MoreHorizontal, Trash2, Settings, Rocket } from 'lucide-react';
      ...
      <div className="flex gap-8">
        <div className="flex-1 min-w-0">
          ...
          <motion.div
            ...
            className="mb-8 flex items-center rounded-[14px] border border-border bg-card p-5"
            style={{ boxShadow: 'var(--shadow-sm)' }}
          >
            {statItems.map((stat, i) => (
              <div key={stat.label} className="flex flex-1 flex-col items-center relative">
                {i > 0 && (
            ...
            <div className="rounded-[14px] border border-border overflow-hidden" style={{ boxShadow: 'var(--shadow-sm)' }}>
              {chatbots.map((bot, i) => (
                ...
                >
                  ...
                  <div className="hidden sm:flex items-center gap-6 text-[12px] text-muted-foreground">
